...
pub use email_routing::{
    ...
    EMAIL_ROUTING_RULES_MAX_PAGES, EMAIL_ROUTING_RULES_PAGE_SIZE, EmailRoutingActionV1,
    EmailRoutingMatcherV1, EmailRoutingRuleDiagnosticV1, EmailRoutingRuleSetV1, EmailRoutingRuleV1,
    is_email_routing_rules_list_capability, normalize_email_routing_account_rule_set,
    normalize_email_routing_account_rule_set_with_page_size, normalize_email_routing_rule_set,
