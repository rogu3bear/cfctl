...
use cfctl_core::{CapabilityV1, WORKER_DEPLOYMENT_PLAN_CAPABILITY_ID, hash_value, redact_json};
...
#[cfg(test)]
pub(super) use live_state::retrievable_rollback_anchor;
pub(super) use live_state::{
    apply_plan_diff, apply_rollback_state_responses, apply_state_responses,
    current_active_deployment_identity, validate_state_receipt,
};
