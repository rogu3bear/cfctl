...
use super::{CliError, wrangler_producer::component_root as producer_component_root};
...
pub(super) const PROJECT_ABSENCE_PRECONDITION: &str = "pages_project_absence";
pub(super) const PROJECT_CREATE_CAPABILITY_ID: &str = "pages-project-create-project";
...
pub(super) const PROJECT_NOT_FOUND_ERROR_CODE: i64 = 8_000_007;
...
fn wrangler_producer_at(capability: &CapabilityV1, discovered: &Path) -> Result<Value, CliError> {
    super::wrangler_producer::snapshot_at(capability, discovered, "pages deploy")
}
