...
- Valid leading verbs are:
  `doctor`, `audit`, `admin`, `bootstrap`, `lanes`, `surfaces`, `docs`, `previews`, `locks`, `env`, `ownership`, `wrangler`, `cloudflared`, `hostname`, `standards`, `token`, `list`, `get`, `can`, `classify`, `guide`, `apply`, `verify`, `explain`, `snapshot`, `diff`, or `error`.
