...
```bash
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.1.1/cfctl-aarch64-apple-darwin
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.1.1/SHA256SUMS
