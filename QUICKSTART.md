...
creation, approval, and run. The apply envelope names the sink path; it does
not carry the token value.
...
Then install and select the **child** profile from that sink:
