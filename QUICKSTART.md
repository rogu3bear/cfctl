...
```bash
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.0.1/cfctl-aarch64-apple-darwin
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.0.1/SHA256SUMS
