...
```bash
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.1.0/cfctl-aarch64-apple-darwin
curl -fsSLO https://github.com/rogu3bear/cfctl/releases/download/v1.1.0/SHA256SUMS
