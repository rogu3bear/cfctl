...
edge proof. Public OAuth remains unconfigured until the canonical product
hostname, site publication, domain verification, and explicit promotion have
all passed their separate live readbacks. Until then, scoped API-token import
remains the supported day-to-day authentication path.
